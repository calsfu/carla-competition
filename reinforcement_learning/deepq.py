...
def learn(env,
    ...
    # intialize policy with imiation learning weights
    weights = torch.load('../im.pth', weights_only=False).state_dict()
    ...
    for t in range(total_timesteps):
        ...
        if t > learning_starts and t % train_freq == 0:
            ...
            loss = perform_qlearning_step(policy_net, target_net, optimizer, replay_buffer, batch_size, gamma, device, double_dqn=True)
